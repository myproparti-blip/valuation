...
const ChatModal = ({ isOpen, onClose, user }) => {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                dispatch(showLoader("Loading conversations..."));
        ...
        fetchData();
    }, [isOpen, user, setConversations, dispatch]);
                                ...
                                {conversations.map((conversation) => {
                                    ...
                                    return (
                                        <div
                                            ...
                                            className={`chat-conversation-item ${activeConversation?._id === conversation._id
                                                    ? "active"
                                                    : ""
                                                }`}
                                ...
                                <div className="chat-messages">
                                    {messages.map((message, index) => (
                                        <div
                                            ...
                                            className={`chat-message ${message.senderId === user.username
                                                    ? "sent"
                                                    : "received"
                                                }`}
                                        >
