...
const handleLocationImageUpload = async (e) => {
    ...
    const canEditClientInfo = role === "admin" || role === "manager1" || role === "manager2";

    const canApprove = (role === "manager1" || role === "manager2" || role === "admin") &&
            ...
            <div className="max-w-7xl mx-auto space-y-6">
                ...
                <Card>
                    <CardHeader className="border-b">
                        ...
                        <CardDescription>Enter complete property location and upload location images</CardDescription>
                    </CardHeader>
                    <CardContent className="p-6">
                        <div className="space-y-6">
                            ...
                            {/* Location Input */}
                            <div className="info-field">
                                <Label className="text-lg font-semibold text-gray-900">Property Location *</Label>
                                <Input
                                    placeholder="Enter complete property location address"
                                    value={formData.location}
                                    onChange={(e) => setFormData(prev => ({ ...prev, location: e.target.value }))}
                                    className="mt-2 text-lg border-gray-300 focus:border-indigo-500"
                                    disabled={!canEdit}
                                />
                            </div>
