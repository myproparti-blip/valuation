        ...
        try {
            ...
            const payload = {
                ...
                pdfDetails: {
                    ...
                    previousValuationIssuedBy: formData.pdfDetails?.previousValuationIssuedBy || "",
                    previousValuationDate: formData.pdfDetails?.previousValuationDate || "",
                    ...
                    planIssueDate: formData.pdfDetails?.planIssueDate || "",
                    planValidity: formData.pdfDetails?.planValidity || "",
                    ...
                    documentsShownToUs: formData.pdfDetails?.documentsShownToUs || [],
                    customDocuments: formData.pdfDetails?.customDocuments || []
                }
            };
            ...
            console.log("ONFINISH - Documents Shown To Us:", payload.pdfDetails?.documentsShownToUs || []);
            console.log("ONFINISH - Custom Documents:", payload.pdfDetails?.customDocuments || []);
            ...
            console.log("API RESPONSE - Documents Shown To Us:", apiResponse?.pdfDetails?.documentsShownToUs || []);
            console.log("API RESPONSE - Custom Documents:", apiResponse?.pdfDetails?.customDocuments || []);
                                                ...
                                                <div>
                                                    ...
                                                    <div className="mb-6 p-6 bg-yellow-50 rounded-2xl border border-yellow-100">
                                                        ...
                                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                            ...
                                                            <div className="space-y-2">
                                                                 <Label className="text-sm font-bold text-gray-900">Plan Issue Date</Label>
                                                                 <Input
                                                                     type="date"
                                                                     value={formData.pdfDetails?.planIssueDate || ""}
                                                                     onChange={(e) => setFormData(prev => ({ ...prev, pdfDetails: { ...prev.pdfDetails, planIssueDate: e.target.value } }))}
                                                                     disabled={!canEdit}
                                                                     className="h-10 text-sm rounded-lg border-2 border-yellow-200 focus:border-yellow-500 focus:ring-yellow-200"
                                                                 />
                                                             </div>
                                                             <div className="space-y-2">
                                                                 <Label className="text-sm font-bold text-gray-900">Previous Valuation Issued By</Label>
                                                                 <Input
                                                                     placeholder="Organization name"
                                                                     value={formData.pdfDetails?.previousValuationIssuedBy || ""}
                                                                     onChange={(e) => setFormData(prev => ({ ...prev, pdfDetails: { ...prev.pdfDetails, previousValuationIssuedBy: e.target.value } }))}
                                                                     disabled={!canEdit}
                                                                     className="h-10 text-sm rounded-lg border-2 border-yellow-200 focus:border-yellow-500 focus:ring-yellow-200"
                                                                 />
                                                             </div>
                                                             <div className="space-y-2">
                                                                 <Label className="text-sm font-bold text-gray-900">Previous Valuation Date</Label>
                                                                 <Input
                                                                     type="date"
                                                                     value={formData.pdfDetails?.previousValuationDate || ""}
                                                                     onChange={(e) => setFormData(prev => ({ ...prev, pdfDetails: { ...prev.pdfDetails, previousValuationDate: e.target.value } }))}
                                                                     disabled={!canEdit}
                                                                     className="h-10 text-sm rounded-lg border-2 border-yellow-200 focus:border-yellow-500 focus:ring-yellow-200"
                                                                 />
                                                             </div>
                                                ...
                                                <div>
                                                        ...
                                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                            ...
                                                            <div className="space-y-2">
                                                                 ...
                                                                 <select
                                                                     ...
                                                                     disabled={!canEdit}
                                                                     className="h-10 text-sm rounded-lg border-2 border-cyan-200 focus:border-cyan-500 focus:ring-cyan-200 w-full px-3"
                                                                 >
                                                    ...
                                                    <div className="mb-6 p-6 bg-rose-50 rounded-2xl border border-rose-100">
                                                        ...
                                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                            ...
                                                            <div className="space-y-2">
                                                                <Label className="text-sm font-bold text-gray-900">Age of the Building (Auto-calculated)</Label>
                                                                <Input
                                                                    placeholder="Age of building"
                                                                    name="buildingAge"
                                                                    value={formData.pdfDetails?.constructionYear ? new Date().getFullYear() - parseInt(formData.pdfDetails.constructionYear) : ""}
                                                                    disabled={true}
                                                                    className="h-10 text-sm rounded-lg border-2 border-amber-200 bg-amber-50"
                                                                />
                                                            </div>
                                                            <div className="space-y-2">
                                                                <Label className="text-sm font-bold text-gray-900">Life of the Building Estimated (Auto-calculated)</Label>
                                                                <Input
                                                                    placeholder="Estimated life"
                                                                    name="buildingLife"
                                                                    value={formData.pdfDetails?.constructionYear ? 60 - (new Date().getFullYear() - parseInt(formData.pdfDetails.constructionYear)) : ""}
                                                                    disabled={true}
                                                                    className="h-10 text-sm rounded-lg border-2 border-amber-200 bg-amber-50"
                                                                />
                                                            </div>
                                                    ...
                                                    <div className="mb-6 p-6 bg-emerald-50 rounded-2xl border border-emerald-100">
                                                        ...
                                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                            ...
                                                            <div className="space-y-2 md:col-span-2">
                                                                <Label className="text-sm font-bold text-gray-900">Copy of Document shown To Us (Press Enter to add)</Label>
                                                                <div className="space-y-2">
                                                                    {/* Chips for predefined documents */}
                                                                    <div className="flex flex-wrap gap-2">
                                                                        {["Mortgage Deed", "Approved Plan", "Previous Valuation Report"].map((doc) => (
                                                                            <button
                                                                                key={doc}
                                                                                onClick={() => {
                                                                                    if (!canEdit) return;
                                                                                    setFormData(prev => ({
                                                                                        ...
                                                                                        pdfDetails: {
                                                                                            ...prev.pdfDetails,
                                                                                            documentsShownToUs: (prev.pdfDetails?.documentsShownToUs || []).includes(doc)
                                                                                                ? (prev.pdfDetails?.documentsShownToUs || []).filter(d => d !== doc)
                                                                                                : [...(prev.pdfDetails?.documentsShownToUs || []), doc]
                                                                                        }
                                                                                    }));
                                                                                }}
                                                                                disabled={!canEdit}
                                                                                className={`px-4 py-2 rounded-full text-sm font-semibold transition-all ${(formData.pdfDetails?.documentsShownToUs || []).includes(doc)
                                                                    ...
                                                                    {/* Input field with selected items inside */}
                                                                    <div className="p-3 bg-white rounded-lg border-2 border-emerald-200 focus-within:border-emerald-500 focus-within:ring-2 focus-within:ring-emerald-200">
                                                                        <div className="flex flex-wrap gap-2 mb-2">
                                                                            {/* Selected predefined documents */}
                                                                            {(formData.pdfDetails?.documentsShownToUs || []).map((doc) => (
                                                                                <div key={doc} className="flex items-center gap-1 bg-emerald-100 text-emerald-900 px-2 py-1 rounded-full text-xs font-medium">
                                                                                    {doc}
                                                                                    {canEdit && (
                                                                                        <button
                                                                                            onClick={() => {
                                                                                                setFormData(prev => ({
                                                                                                    ...
                                                                                                    pdfDetails: {
                                                                                                        ...prev.pdfDetails,
                                                                                                        documentsShownToUs: (prev.pdfDetails?.documentsShownToUs || []).filter(d => d !== doc)
                                                                                                    }
                                                                                                }));
                                                                                            }}
                                                                                            className="ml-1 text-emerald-900 hover:text-emerald-700 font-bold"
                                                                                        >
                                                                                            ×
                                                                                        </button>
                                                                                    )}
                                                                            ...
                                                                            {(formData.pdfDetails?.customDocuments || []).map((customDoc, idx) => (
                                                                                <div key={`custom-${idx}`} className="flex items-center gap-1 bg-blue-100 text-blue-900 px-2 py-1 rounded-full text-xs font-medium">
                                                                                    {customDoc}
                                                                                    {canEdit && (
                                                                                        <button
                                                                                            onClick={() => {
                                                                                                setFormData(prev => ({
                                                                                                    ...
                                                                                                    pdfDetails: {
                                                                                                        ...prev.pdfDetails,
                                                                                                        customDocuments: (prev.pdfDetails?.customDocuments || []).filter((_, i) => i !== idx)
                                                                                                    }
                                                                                                }));
                                                                                            }}
                                                                            ...
                                                                            {/* Input for custom documents - press Enter to add */}
                                                                            <input
                                                                                type="text"
                                                                                placeholder="Type document name and press Enter"
                                                                                value={formData.pdfDetails?.customDocumentInput || ""}
                                                                                onChange={(e) => setFormData(prev => ({ ...prev, pdfDetails: { ...prev.pdfDetails, customDocumentInput: e.target.value } }))}
                                                                                onKeyPress={(e) => {
                                                                                    if (e.key === 'Enter' && formData.pdfDetails?.customDocumentInput?.trim()) {
                                                                                        e.preventDefault();
                                                                                        setFormData(prev => ({
                                                                                            ...prev,
                                                                                            pdfDetails: {
                                                                                                ...prev.pdfDetails,
                                                                                                customDocuments: [...(prev.pdfDetails?.customDocuments || []), prev.pdfDetails.customDocumentInput.trim()],
                                                                                                customDocumentInput: ''
                                                                                            }
                                                                                        }));
                                                                                    }
