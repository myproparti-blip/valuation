...
import { createValuation, getValuationById, updateValuation, managerSubmit, requestRework, getAllValuations } from "../controllers/valuationController.js";
...
router.post("/:id/request-rework", isManagerOrAdmin, requestRework);
